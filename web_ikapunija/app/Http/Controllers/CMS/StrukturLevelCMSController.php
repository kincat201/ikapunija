...
class StrukturLevelCMSController extends Controller
{
        ...
        if($request->session()->has('nama'))       
        {
            ...
            if ($request->ajax()) {
                ...
                $componentAPI += array (
                    ...
                    'email'     => session('email'),
                    'token'     => session('token'),
                    'successMsg'=> 'Success Get Struktur Level List',
                    'mode'      => 'get',
                    'offset'    => '',
                    'limit'     => '',
                    'sort'      => array('', ''),
                    ...
                    'searchCol' => [],
                    'type'      => 'admin',
                    'sql'       => StrukturLevel::exclude($exclude),
                    'addCase'   => array (
                        ['and', 'is_active', '=', 'Y'], 
                    )
                );
            ...
            return view('cms/strukturLevel', compact('username'));
        }
