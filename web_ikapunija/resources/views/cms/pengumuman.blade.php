    ...
    <div class="modal fade" id="modal-crud">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-header">
                <h4 id="modal-title" class="modal-title">Pengumuman</h4>
...
<script>
            ...
            columns: [
                ...
                {data: 'review_singkat'},
                {
                    ...
                    render:function(data, type, row){
                        return '<a href="<?php echo $url.'pengumuman/'; ?>'+row.foto+'" target="_blank">Lihat Foto</a>';
                    }
                },
                {data: 'category'},
                {data: 'priority'},
    ...
    function addData() {
       ...
       $.ajax({
            type: "POST",
            url: '<?php echo env('APP_URL').'api/addPengumuman'; ?>',
            headers: {
    ...
    function getDetail(obj) {
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo env('APP_URL').'api/pengumuman/'; ?>'+id,
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "type":"web",
            },
            ...
            success: function(data) {
                ...
                {   
                    ...
                    $("#ves_fotoImg").data('images', '<?php echo $url."pengumuman/"; ?>'+data.Data.foto);
                }
            }
        });
    }
    ...
    function editData() {
       ...
       $.ajax({
            type: "PUT",
            url: '<?php echo env('APP_URL').'api/editPengumuman'; ?>',
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "email":"<?php echo session('email'); ?>",
                "token":"<?php echo session('token'); ?>",
    ...
    function deleteData() {
       ...
       $.ajax({
            type: "DELETE",
            url: '<?php echo env('APP_URL').'api/delPengumuman'; ?>',
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "email":"<?php echo session('email'); ?>",
                "token":"<?php echo session('token'); ?>",
