    ...
    <div class="modal fade" id="modal-crud">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-header">
                <h4 id="modal-title" class="modal-title">CDC</h4>
            ...
            <div class="modal-body">
                <form id="form_submit"> 
                    ...
                    <!-- Date range -->
                    <div class="form-group ves-custom" id="ves_tanggal">
                        <label class="d-flex">Tanggal Mulai - Selesai: <div class="cus_req" id="req_tanggal">&nbsp*</div></label>
                    ...
                    <div class="form-group ves-custom" id="ves_link">
                        <label class="d-flex">Link <div class="cus_req" id="req_link">&nbsp*</div></label>
                        <input type="text" class="form-control form-custom" id="form_link" placeholder="Enter Link">
                    </div>
                </form>
            </div>
...
<script>
            ...
            columns: [
                ...
                {data: 'review_singkat'},
                {
                    ...
                    render:function(data, type, row){
                        return '<a href="<?php echo $url.'cdc/'; ?>'+row.foto+'" target="_blank">Lihat Foto</a>';
                    }
                },
                {data: 'category'},
                {data: 'priority'},
    ...
    function addData() {
       ...
       $.ajax({
            type: "POST",
            url: '<?php echo env('APP_URL').'api/addCDC'; ?>',
            headers: {
    ...
    function getDetail(obj) {
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo env('APP_URL').'api/loker/'; ?>'+id,
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "email":"<?php echo session('email'); ?>",
                "token":"<?php echo session('token'); ?>",
            ...
            success: function(data) {
                ...
                {   
                    ...
                    startDate = moment(data.Data.start_date).format("MM/DD/YYYY");
                    endDate = moment(data.Data.end_date).format("MM/DD/YYYY");
                    ...
                    $("#ves_fotoImg").data('images', '<?php echo $url."loker/"; ?>'+data.Data.foto);
                }
            }
        });
    }
    ...
    function editData() {
       ...
       $.ajax({
            type: "PUT",
            url: '<?php echo env('APP_URL').'api/editCDC'; ?>',
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "email":"<?php echo session('email'); ?>",
                "token":"<?php echo session('token'); ?>",
    ...
    function deleteData() {
       ...
       $.ajax({
            type: "DELETE",
            url: '<?php echo env('APP_URL').'api/delCDC'; ?>',
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "email":"<?php echo session('email'); ?>",
                "token":"<?php echo session('token'); ?>",
