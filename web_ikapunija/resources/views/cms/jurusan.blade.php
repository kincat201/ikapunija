            ...
            <div class="modal-body">
                <form id="form_submit"> 
                    ...
                    <div class="form-group ves-custom" id="ves_judul">
                        ...
                        <input type="text" class="form-control form-custom" id="form_nama" placeholder="Nama Jurusan" maxlength="50">
                    </div>
                </form>
            </div>
...
<script>
    ...
    function addData() {
       var input = {
            'nama_jurusan': $("#form_nama").val(),
       };

       $.ajax({
            type: "POST",
            url: '<?php echo env('APP_URL').'api/addJurusan'; ?>',
            headers: {
    ...
    function getDetail(obj) {
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo env('APP_URL').'api/jurusan/'; ?>'+id,
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "type":"web",
            },
            ...
            success: function(data) {
                ...
                { 
                    $("#form_nama").val(data.Data.nama_jurusan);
                    $("#form_id").val(id);
                }
            }
        });
    ...
    function editData() {
       ...
       $.ajax({
            type: "PUT",
            url: '<?php echo env('APP_URL').'api/editJurusan'; ?>',
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "email":"<?php echo session('email'); ?>",
                "token":"<?php echo session('token'); ?>",
    ...
    function deleteData() {
       ...
       $.ajax({
            type: "DELETE",
            url: '<?php echo env('APP_URL').'api/delJurusan'; ?>',
            headers: {
                "apiToken":"<?php echo env('APPS_KEY'); ?>",
                "email":"<?php echo session('email'); ?>",
                "token":"<?php echo session('token'); ?>",
